###  Assume all vcf.gz files are in ./no_filter/*.gz;
###  These vcf file were generated by Mutect2-PoN.sh script 
...
bcftools merge -0 -Oz -o ./gnomad30_filter2/Allsample124_gnomad30.vcf.gz -l ./tm
bcftools index -t ./gnomad30_filter2/Allsample124_gnomad30.vcf.gz
bcftools view -C 2 -c 1 -Ov ./gnomad30_filter2/Allsample124_gnomad30.vcf.gz | grep -v '#' | cut -f '1,2' > max2.list # make list containing mutation in <2 subjects.

for sample in `cat ../sampleinfo124` #sampleinfo124 containing only the sample ID
do
sn=${sample}
